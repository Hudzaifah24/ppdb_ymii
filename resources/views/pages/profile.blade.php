            ...
            <div class="w-full max-w-full px-3 xl:w-4/12">
              <div class="relative flex flex-col h-full min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
                ...
                <div class="flex-auto p-4">
                  ...
                  <form id="createInvoice" action="{{ route('create.invoice') }}" method="post">
                    @csrf
                    @method('POST')
                </form>
                    <button form="createInvoice" class="inline-block px-8 py-2 my-2 text-xs font-bold text-center text-white uppercase align-middle transition-all ease-in border-0 rounded-lg select-none shadow-soft-md bg-150 bg-x-25 leading-pro bg-gradient-to-tl from-slate-700 to-blue-500 hover:shadow-soft-2xl hover:scale-102">Bayar Pendaftaran</button>
                </div>
              </div>
            </div>
          @endif
