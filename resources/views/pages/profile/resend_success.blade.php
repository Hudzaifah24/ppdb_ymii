          ...
          <div class="container z-10">
            <div class="flex flex-wrap justify-center -mx-3">
              <div class="w-full max-w-full px-3 mx-auto mt-0 text-center lg:flex-0 shrink-0 lg:w-5/12">
                <h1 class="mt-12 mb-2 text-white">Alhamdulillah!</h1>
                <p class="text-white">Silahkan lihat email anda.</p>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="flex-auto p-6">
                  <div role="form text-left">
                    <div class="text-center">
                      <a target="__blank" href="https://mail.google.com/mail/u/0/#inbox" class="inline-block w-full px-6 py-3 mt-6 font-bold text-center text-white uppercase align-middle transition-all bg-transparent border-0 rounded-lg cursor-pointer active:opacity-85 hover:scale-102 hover:shadow-soft-xs leading-pro text-xs ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25 bg-gradient-to-tl from-green-900 to-green-800 hover:border-slate-700 hover:bg-slate-700 hover:text-white">Buka Gmail</a>
                      <a href="{{ route('konfirmasi') }}" class="inline-block w-full px-6 py-3 mt-6 mb-2 font-bold text-center text-white uppercase align-middle transition-all bg-transparent border-0 rounded-lg cursor-pointer active:opacity-85 hover:scale-102 hover:shadow-soft-xs leading-pro text-xs ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25 bg-gradient-to-tl from-gray-900 to-slate-800 hover:border-slate-700 hover:bg-slate-700 hover:text-white">Halaman Konfirmasi</a>
                    </div>
                  </div>
                </div>
              </div>
