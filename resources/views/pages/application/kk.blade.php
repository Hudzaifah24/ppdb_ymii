...
<html lang="en">
  <head>
    ...
    <title>YMII | Kartu Keluarga</title>
        ...
        <div class="flex items-center justify-between w-full px-6 py-1 mx-auto flex-wrap-inherit">
          <nav>
            ...
            <ol class="flex flex-wrap pt-1 pl-2 pr-4 mr-12 bg-transparent rounded-lg sm:mr-16">
              ...
              <li class="text-sm pl-2 capitalize leading-normal before:float-left before:pr-2 before:content-['/']" aria-current="page">Upload Kartu Keluarga</li>
            </ol>
            <h6 class="mb-2 ml-2 font-bold text-white capitalize">Upload Kartu Keluarga</h6>
          </nav>
            ...
            <div class="w-full max-w-full px-3 lg-max:mt-6 xl:w-full">
                <div class="relative flex flex-col h-full min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
                    @if ($user->Application->kartu_keluarga != NULL)
                        <a href="{{ asset('assets/img/documents/'.$user->Application->kartu_keluarga) }}" target="__blank">
                            <img class="object-cover h-full w-full rounded-lg" src="{{ $user->Application->kartu_keluarga ? asset('assets/img/documents/'. $user->Application->kartu_keluarga) : '' }}">
                        </a>
                    @endif
                  ...
                  <div class="flex-auto p-4">
                    <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                        <form role="form text-left" action="{{ route('kk.proses', $user->username) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
